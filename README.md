...
ENABLE_LLM_ENRICHMENT=true # Set to 'true' to enable enrichment (default: disabled in repo)
LLM_ASYNC_METHOD=true # Set to 'true' to enable asynchronous llm connection for enrichments
